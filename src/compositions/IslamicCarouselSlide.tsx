...
export const THEMES: Record<ThemeKey, { bg: string; ink: string; accent: string; muted: string; label: string }> = {
  ...
  "cerulean-honey": { bg: "#0E2A47", ink: "#F5EFE0", accent: "#E3A857", muted: "#5B7A99", label: "Cerulean & Honey" },
