...
export const YourPocketShort: React.FC<ShortProps> = ({ url = URL, audioUrl = "sounds/bbmw0-stream.mp3" }) => (
  <ThemedShort themeId="forest" beats={yourPocketBeats(url)} audioUrl={audioUrl} audioVolume={0.5} />
);
export const yourPocketShortDefaults: ShortProps = { url: URL, audioUrl: "sounds/bbmw0-stream.mp3" };
